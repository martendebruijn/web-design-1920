...
- [x] RUBRIC
  - [x] Student kan uitleggen wat de Exclusive Design Principles zijn.
    ...
    - [x] Add nonsens
  - [x] Student laat zien hoe de Exclusive Design Principles zijn toegepast in het ontwerp.
  - [x] Readme: In de beschrijving van het project staat de opdracht uitgelegd, is het probleem duidelijk beschreven en hoe het probleem is opgelost.
  - [x] Er is een user scenario geschreven dat aansluit bij de identiteit van de test persoon
    - [x] Er is een duidelijk en volledig user scenario geschreven dat antwoord geeft op de 4 w-vragen: Who? What? How? en Why?
  - [x] Er zijn verschillende tests gedaan en verwerkt om het ontwerp te verbeteren.
    - [x] Conclusies!
  - [x] De student kan een test opzetten en toepassen in een ontwerp
